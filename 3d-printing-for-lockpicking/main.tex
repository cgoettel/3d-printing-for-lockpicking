...
% B: I was going for "there is more securitry research" but more broad. I think this fits better
...
% B: the parts that make up the system, changed to "individual"
...
% B: changed to "standard physical".

...
% C: I think it's fine as is. Speak now or forever hold your peace.
...
% Your use of em dashes was a little off here. They are different than commas and colons. An em dash is a two-way directionality, A<->B. A colon is only A->B and typically more formal, where em dashes are more casual.
% B: changed to a comma, clarified the last sentence a bit

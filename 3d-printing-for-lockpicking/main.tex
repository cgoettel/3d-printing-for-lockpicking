...
The rise of cryptographically-keyed, electronically-controlled physical locking systems provides an alternative that avoids many of the vulnerabilities presented here. Increasing adoption of these systems continues to drive down their cost and improves secure operation best practices.
% What do you mean by "visibility" here?
% B: I was going for "there is more security research" but more broad. I think this fits better
% Changed "adds to" to "improves." Is that correct?

...
% xxxx watch out for em dashes, i added some - byron
...
\begin{abstract}
    ...
    % B: This is good. When I went through the paper yesterday I changed the language to reflect my statement yesterday as well. I will give it a second pass now, too.
...
% B: Changed to "preset mechanical locks"
...
% B: Does this satisfy Dale's comment or do you think there should be more?

% I used the term "countermeasure." Is this correct?
% B: Yes, that is fitting term.
...
% B: Removed POV shift. Changed "alleviate" to "enhance" in last sentence. Hyphenated "high security". Looks good otherwise. Changed to "preset mechanical lock systems"
...
% B: "Advantages and disadvantages"? What do you think?
...
% B: High fidelity can be done w/o DMLS. The main advantage is high fidelity + strong metal parts. Maybe "high fidelity, high strength prototypes and finished products"?
...
%B: Changed to "preset mechanical lock systems"
...
% B: Missed this one in editing, it is a tube lock. Cylinder locks are something else entirely. Changed. Confusing... tube locks have lock cylinders, cylinder locks have lock tubes. :C
...
% B: This was meant to be part of the intro's summary, and to introduce the idea of raking/scrubbing interchangability. Should be higher but I understand the ordering problem. What do you think? I am thinking we can just remove the first sentence:
% In addition to single-pin picking, a number of attacks across multiple pins can be used. Raking, scrubbing, and bumping are three possible methods.
...
% B: np, reworded a few things in this paragraph
...
% B: Added another sentence here, forgot about this but it is important. Also supports the conclusion :D
...
% B: you should be pedantic here :D
% The last sentence needs a lot of work. Take a crack at it and I'll finalize.
% B: Split it up some, reworded. Let me know what you think.
...
% B: removed comma, also technical writing is all coming back to me
...
% was this better? Yes.
% B: here is my response to this comment to confuse you while looking at the diffs. also, awesome.
...
% B: reworded, also added a bit to strengthen, i felt this was still a bit weak
...
\subsection{Copying}
% B: "Preset..." I think that was the last one.
...
% B: done, made some changes to keep symetrical structure there
